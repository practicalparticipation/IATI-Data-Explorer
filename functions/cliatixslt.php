<?php
  ...
  if(file_exists($filename)) {
   ...
   $xslDoc->load("iati-json-lite.xsl");
   ...
   $outdir = str_replace("cliatixslt.php","",__FILE__);
...
{ "items": [{
	"type": "type-1",
	"id": "error",
	"uri": "http://projects.dfid.gov.uk/",
"label": "Error",
"description": "The script fetching data from DFID took longer than 30 seconds and so we were unable to prepare data for this interface. It is possible that by refreshing this page a full view of the data you requested will be available",
"start-date": "2000-01-01",
"end-date": "2010-01-01",
"activity-status": "Error",
"collaboration-type": "Try refreshing for data",
"default-flow-type": "Try refreshing for data",
"default-aid-type": [ ],
"reporting-org": "N/A",
"participating-org": [],
"currency": "NA",
"total-committments": 0,
"policy-marker": [ ],
"sector": [ ],
"sector-amounts": [ ],
"components": [],
"parents": [ ],
"recipient-country": "NA",
